...
/* PDE */
#define PG_P		EQU	1	; 页存在属性位
#define PG_RWR		EQU	0	; R/W 属性位值, 读/执行
#define PG_RWW		EQU	2	; R/W 属性位值, 读/写/执行
#define PG_USS		EQU	0	; U/S 属性位值, 系统级
#define PG_USU		EQU	4	; U/S 属性位值, 用户级
